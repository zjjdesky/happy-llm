...
![图3.1 BERT 模型结构](../images/3-figures/1-0.png)
...
![图3.2 BERT 模型简略结构](../images/3-figures/1-1.png)
...
![图3.3 prediction_heads 结构](../images/3-figures/1-5.png)


而每一层 Encoder Layer 都是和 Transformer 中的 Encoder Layer 结构类似的层，如图3.4所示：

![图3.4 Encoder Layer 结构](../images/3-figures/1-2.png)
...
![图3.5 Intermediate 结构](../images/3-figures/1-3.png)
...
![图3.6 BERT 注意力机制结构](../images/3-figures/1-4.png)
...
![图3.7 T5 模型详细结构](../images/3-figures/2-1.png)
...
![图3.8 T5 模型整体结构](../images/3-figures/2-2.png)
...
![图3.9 Encoder 和 Decoder](../images/3-figures/2-3.png)
...
![图3.10 Self-Attention 结构](../images/3-figures/2-4.png)
...
![图3.11 T5 的大一统思想](../images/3-figures/2-0.png)
...
![图3.12 GPT 模型结构](../images/3-figures/3-0.png)
...
![图3.13 LLaMA-3 模型结构](../images/3-figures/3-1.png)
...
![图3.14 GLM 模型结构](../images/3-figures/3-2.png)
...
![图3.15 GLM 模型表现演进](../images/3-figures/3-3.png)
